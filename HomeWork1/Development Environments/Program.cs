...
namespace Development_Environments
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            5.IntelliJIdea -IntelliJ IDEA 14 comes with a built-in decompiler for Java classes. When you want to take a look inside a library that you don't have the source code for, now you can – without any third-party plugins.
		    */
        }
    }
}
