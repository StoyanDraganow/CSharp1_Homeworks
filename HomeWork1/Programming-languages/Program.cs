...
namespace Programming_languages
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            3. C++
            -It is one of the most popular programming languages, winning fourth place on the list, with application domains including systems software, application software, server and client applications, and entertainment software such as video games.  
            The language has also greatly influenced many other popular programming languages, such as C# and Java
            ...
            5. JavaScript
            -JavaScript is a dynamic programming language that is most commonly used as part of web browsers, whose implementations allow client-side 
            scripts to interact with the user, control the browser, communicate asynchronously, and alter the document content that is displayed.

            Maybe the major differences between JS and C# are that JS can be run on any platform, directly in any browser and is interpreted as opposed
